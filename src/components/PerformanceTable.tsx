                ...
                {customEvents.map((event, eventIndex) => (
                  <td key={event} className="px-4 py-3 whitespace-nowrap">
                    <input
                      ...
                      className="w-full px-2 py-1 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-[var(--brand-accent-hover)] focus:border-[var(--brand-start)]"
                      placeholder=""
                    />
                  </td>
                ))}
